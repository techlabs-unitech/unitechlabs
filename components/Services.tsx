...
const services = [
  ...
  { num: '06', title: 'Custom software Development', desc: 'Benefit from our data-driven services and leverage our expertise to build custom and highly functional solutions with substantial ROI.', icon: <DataIcon /> },
]
        ...
        <div className={styles.grid}>
          {services.map(s => (
            <div key={s.num} className={styles.card}>
              ...
              <a
                href="https://desk.unitechlabs.io/login"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.cardLink}
              >
                Learn more <ChevRight />
              </a>
            </div>
          ))}
        </div>
...
function DataIcon()    { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><line x1="2" y1="20" x2="22" y2="20"/></svg> }
